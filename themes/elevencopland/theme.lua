...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/elevencopland"
...
local mytextclock = wibox.widget.textclock("<span font='Misc Tamsyn 5'> </span>%I:%M %p ")
...
theme.volume.bar:buttons(my_table.join (
        --   awful.button({}, 1, function() -- commented out because i don't want it
...
theme.weather = lain.widget.weather({
    city_id = 4722625, -- Richardson, Texas
    units = "imperial",
    followtag = true,
    utc_offset = 6,
})
